...
describe Venue do
  ...
  describe '#over_capacity' do 
    it 'returns true if the number of patrons is greater than the capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
      venue.add_patron('Sarah')
      venue.add_patron('Billy')
      expect(venue.over_capacity).to eq true
    end
    it 'returns false if the number of patrons is less than the capacity' do
      venue = Venue.new('Bluebird', 4)
      venue.add_patron('Mike')
      venue.add_patron('Megan')
      venue.add_patron('Bob')
...
describe '#kick_out' do
  it 'removes the first patron if the venue is over capacity' do
    venue = Venue.new('Bluebird', 4)
    venue.add_patron('Mike')
    venue.add_patron('Megan')
    venue.add_patron('Bob')
    ...
    venue.add_patron('Billy')
    venue.kick_out
    expect(venue.patrons).to eq ['Megan', 'Bob', 'Sarah', 'Billy']
  end
end
